...
import fetchRecords from '@salesforce/apex/V2MOM_LinkReportClass.fetchRecords';

export default class ReportLookupField extends LightningElement {
    @api objectName;
    @api fieldName;
    @api value;
    @api iconName;
    ...
    onReportChange(){
        const selectedEvent = new CustomEvent("reportselected", {
